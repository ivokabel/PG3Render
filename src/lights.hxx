...
public:
        ...
        ) const
    {
        ...
        const Vec2f baryCoords = Utils::SampleUniformTriangle(rnd);
...
public:
        ...
        ) const
    {
        ...
        else
        {
            if ((oPdfW != NULL) && (aSurfFrame != NULL))
                *oPdfW = Utils::CosHemispherePdfW(aSurfFrame->Normal(), aWig);
        ...
        ) const
    {
        ...
        else
        {
            ...
            Vec3f wil = Utils::SampleCosSphereParamPdfW(
        ...
        ) const
    {
        ...
        if (mEnvMap != NULL)
        {
            ...
            for (uint32_t round = 0; round < count; round++)
            {
                ...
                const float pdf2Cos = Utils::CosHemispherePdfW(aSurfFrame.Normal(), sample2.mWig);
