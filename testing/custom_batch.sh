...
"$PG3RENDER" -od "$IMAGES_BASE_DIR_WIN" -e hdr -a pt -s 7 -t 120 -sb 8 -sl 1.0 -slbr  0.1
"$PG3RENDER" -od "$IMAGES_BASE_DIR_WIN" -e hdr -a pt -s 7 -t 120 -sb 8 -sl 1.0 -slbr  1.0
"$PG3RENDER" -od "$IMAGES_BASE_DIR_WIN" -e hdr -a pt -s 7 -t 120 -sb 8 -sl 1.0 -slbr 10.0
